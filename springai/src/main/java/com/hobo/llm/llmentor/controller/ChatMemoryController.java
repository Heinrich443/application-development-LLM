...
public class ChatMemoryController implements InitializingBean {
    ...
    public Flux<String> callConversation(String message, String conversationId, HttpServletResponse response) {
    ...
    public void afterPropertiesSet() throws Exception {
        chatMemory = MessageWindowChatMemory.builder().maxMessages(3).build();
